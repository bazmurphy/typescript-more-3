...
const getUsersProperty = (users, // we pass in an array of users
key // and we pass in a key
) => {
...
const store4 = new StateObject("Bill");
const store5 = new StateObject(1);
// we can even use union types, to state its an array of string/number/booleans
const store6 = new StateObject([15]);
